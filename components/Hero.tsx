    ...
    return (
        <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
            ...
            <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
                ...
                <h1 className='bold-52 lg:text-[88px]'>Putuk Truno Camp Area</h1>
                ...
                <p className='regular-16 mt-6 text-gray-50 xl:max-w-[520px]'>
                    ...
                    We can help you on an adventure around
            ...
            <div className='relative flex flex-1 items-start'>
                <div className='relative z-20 flex w-[268px] flex-col gap-8 bg-green-90 rounded-3xl px-7 py-8'>
